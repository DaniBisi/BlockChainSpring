...
public class QueryControllerTest {
	...
	public void testQueryPageWithLogin() throws Exception {
		...
		ParseAnsware p1 = mock(ParseAnsware.class);
		String jsonAnswareMocked = "[{\"Key\":\"0\", \"Record\":{\"IDhash\":\"ec363bd2b1c7715e48ace871bb7fe64820ace657\",\"agency\":\"Magenta3.58\",\"date\":\"10-04-18:9.49\",\"name\":\"Admin\"}},{\"Key\":\"1\", \"Record\":{\"IDhash\":\"158ec78ab7b9190385379230587a7ca8e0d33383\",\"agency\":\"Unifi\",\"date\":\"10-04-18:9.48\",\"name\":\"User2\"}},{\"Key\":\"2\", \"Record\":{\"IDhash\":\"1b740424702841d0529c9af5c8478d25ead55379\",\"agency\":\"Unifi\",\"date\":\"10-04-18:9.47\",\"name\":\"User1\"}},{\"Key\":\"3\", \"Record\":{\"IDhash\":\"f480397b54c1b0f9bc403985eb4700ae1b1c672f\",\"agency\":\"Magenta\",\"date\":\"10-04-18:9.46\",\"name\":\"Admin\"}},{\"Key\":\"4\", \"Record\":{\"IDhash\":\"18281e6f75fe1412d0f2afa2894050677e4c456a\",\"agency\":\"Magenta\",\"date\":\"10-04-18:9.45\",\"name\":\"Admin\"}},{\"Key\":\"5\", \"Record\":{\"IDhash\":\"ee24822909bb95354f3f43c964a4b988c7de66a6\",\"agency\":\"Unifi\",\"date\":\"10-04-18:9.44\",\"name\":\"User2\"}},{\"Key\":\"6\", \"Record\":{\"IDhash\":\"343af2b08f306b8b407dd6d57d7a95b699479d1e\",\"agency\":\"Unifi\",\"date\":\"10-04-18:9.43\",\"name\":\"User1\"}},{\"Key\":\"7\", \"Record\":{\"IDhash\":\"e13b501f310f19651757d46555223c82f6fdc4c1\",\"agency\":\"Magenta\",\"date\":\"10-04-18:9.42\",\"name\":\"Admin\"}},{\"Key\":\"8\", \"Record\":{\"IDhash\":\"a8ed3cac9e9280b664e409b6c5e16ef969ad7f5a\",\"agency\":\"Unifi\",\"date\":\"10-04-18:9.42\",\"name\":\"User2\"}},{\"Key\":\"9\", \"Record\":{\"IDhash\":\"8c88abef1efda183eb66475f001ff4ea200266f9\",\"agency\":\"Magenta\",\"date\":\"10-04-18:9.41\",\"name\":\"Admin\"}}]";
		when(p1.execute(Mockito.anyString())).thenReturn(l1);
		when(parserStrategy.getFormattedQuery(Mockito.anyString(), Mockito.anyString())).thenReturn(args);
		when(parserStrategy.getCommandParser(Mockito.anyString())).thenReturn(p1);
		...
		mockMvc.perform(get("/query").session(session).param("query", "queryAllVisits").param("args", ""))
				.andExpect(view().name("response")).andExpect(model().attribute("records", l1))
	...
	public void testQueryPageWithLoginRecordNotEmpty() throws Exception {
		...
		valNameMocked.add("mockede1");
		Items e1 = mock(Items.class);
		when(e1.getValName()).thenReturn(valNameMocked);
		l1.add(e1);
		mockRepository = mock(BCRepository.class);
		String[] args = { "QueryAllVisits", "" };
		ParseAnsware p1 = mock(ParseAnsware.class);
